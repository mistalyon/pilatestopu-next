...
export const metadata: Metadata = {
  ...
  description:
    "Pilates hakkında her şey: reformer pilates, mat pilates egzersizleri, beslenme önerileri, hamile pilatesi ve zayıflama rehberleri. Uzman içerikleriyle sağlıklı yaşamınıza yön verin.",
  keywords: [
    "pilates blog",
    "pilates rehberi",
    "reformer pilates",
  ...
  openGraph: {
    title: "Pilates Blog: Egzersizler, Rehberler ve Beslenme Önerileri",
    description:
      "Pilates hakkında her şey: reformer pilates, mat pilates, beslenme, hamile pilatesi ve daha fazlası.",
    url: SITE_URL + "/blog",
    type: "website",
  ...
  twitter: {
    ...
    title: "Pilates Blog: Egzersizler, Rehberler ve Beslenme Önerileri",
    description:
      "Pilates hakkında her şey: reformer pilates, mat pilates, beslenme ve daha fazlası.",
  },
};
...
export default async function BlogPage() {
  ...
  const jsonLd = {
    ...
    name: "Pilates Blog",
    description:
      "Pilates hakkında egzersizler, rehberler, beslenme önerileri ve uzman içerikleri.",
    url: SITE_URL + "/blog",
    isPartOf: { "@type": "WebSite", name: "PilatesTopu", url: SITE_URL },
    about: { "@type": "Thing", name: "Pilates" },
    inLanguage: "tr",
    mainEntity: {
      "@type": "ItemList",
      ...
      <section className="bg-gradient-to-r from-[#730EC3] to-[#E91E90] py-16 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-white/90">
            Pilates dünyasından yazılar, rehberler ve öneriler
          </p>
        </div>
      </section>
