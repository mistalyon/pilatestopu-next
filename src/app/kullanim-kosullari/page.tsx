      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose max-w-none">
          ...
          <p className="text-gray-700 mb-4">
            ...
            etmiş sayılırsınız. Siteyi kullanmaya devam etmeniz bu koşullları
          ...
          <p className="text-gray-700 mb-4">
            ...
            platformudur. Platform üzerindeki işletme bilgileri ilgili işletmeler
          ...
          <p className="text-gray-700 mb-4">
            ...
            sorumluluk kabul etmez. Kullanıcılar işletmelerle doğrudan iletişime
            geçerek hizmet detaylarını teyit etmelidir.
          </p>
