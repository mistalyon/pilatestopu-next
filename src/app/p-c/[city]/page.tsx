    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">
          {cityData.name}&apos;da Pilates Salonları
        </h2>
        ...
        {places.length > 0 ? (
              ...
              >
                ...
                {place.rating && (
                  <div className="flex items-center gap-2">
                    ...
                    {place.review_count && (
                      <span className="text-gray-400 text-sm">({place.review_count} değerlendirme)</span>
                    )}
                  </div>
                )}
              </Link>
          ...
          <div className="bg-purple-50 rounded-xl p-8 text-center mb-16">
            <p className="text-gray-600 mb-4">
              {cityData.name} için salon bilgileri yakında eklenecektir.
            </p>
        ...
        <div className="prose max-w-none mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            {cityData.name} Pilates Rehberi
          </h2>
          <p className="text-gray-600 leading-relaxed">
            {cityData.name} pilates salonları arasında reformer pilates, mat pilates, klinik pilates ve hamile pilatesi gibi
            farklı türlerde dersler sunan stüdyolar bulunmaktadır. {cityData.name}&apos;da pilates yapmak isteyenler
            için en uygun salonu bulmalarına yardımcı oluyoruz. PilatesTopu.com üzerinden {cityData.name} ve
            çevresindeki tüm pilates salonlarını, fiyatlarını ve kullanıcı yorumlarını karşılaştırabilirsiniz.
          </p>
        </div>
      </section>
