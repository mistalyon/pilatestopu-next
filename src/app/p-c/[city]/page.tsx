        ...
        <>
              ...
              <section className="bg-gradient-to-br from-purple-700 via-purple-600 to-pink-500 text-white py-16">
                      <div className="max-w-7xl mx-auto px-4">
                                <nav className="text-sm text-purple-200 mb-4 flex items-center gap-2 flex-wrap">
                                            <Link href="/" className="hover:text-white">Anasayfa</Link>Link>
                                            <span className="mx-2">/</span>span>
                                            <Link href="/p-c" className="hover:text-white">Salonlar</Link>Link>
                                            <span className="mx-2">/</span>span>
                                            <span className="text-white">{cityData.name}</span>span>
                                </nav>nav>
                            ...
                            <div className="max-w-7xl mx-auto px-4">
                                    ...
                                    return (
                                                        <Link key={n.slug} href={"/p-c/" + city + "/" + n.slug}
                                                                            ...
                                                                            <span className="text-gray-700 group-hover:text-purple-700 font-medium text-sm">{n.name}</span>span>
              ...
              <section className="max-w-7xl mx-auto px-4 py-16">
                ...
                {places.length > 0 ? (
                      ...
                      {places.map(function(place: any) {
                                    return (
                                                      <Link key={place.id} href={"/salon/" + place.slug}
                                                                        ...
                                                                        <div className="p-5">
                                                                                            <h3 className="font-bold text-lg text-gray-900 group-hover:text-purple-600">{place.name}</h3>h3>
                                                                          {place.address && (
                    ...
                    <div className="bg-gray-50 rounded-2xl p-12 text-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-700 mb-2">Salonlar Yakında Eklenecek</h3>h3>
          ...
          {/* SEO İçerik Bölümü */}
              <section className="bg-white py-16">
                      <div className="max-w-4xl mx-auto px-4">
                                <h2 className="text-2xl font-bold text-gray-900 mb-6">{cityData.name} Pilates Rehberi</h2>h2>
          ...
          {/* Diğer Şehirler */}
              <section className="bg-gray-50 py-16">
                      <div className="max-w-7xl mx-auto px-4">
                                <h2 className="text-3xl font-bold text-gray-900 mb-8">Diğer Şehirler</h2>h2>
                        ...
                        return (
                                          <Link key={c.slug} href={"/p-c/" + c.slug}
                                                            ...
                                                            <span className="font-medium text-gray-900">{c.name}</span>span>
                                                            <span className="block text-sm text-gray-500">{c.studio_count}+ salon</span>span>
                                          </Link>Link>
                                        );
        })}
                                </div>div>
